 ...
 */
public class AudioRecoderUtils implements AudioWatched {
    ...
    public long stopRecord() {
        ...
        try {
            ...
            notifyAudioFileSaveSuccess(new AudioModel(filePath,time));
            filePath = "";
    ...
    private List<AudioWatcher> list = new ArrayList<AudioWatcher>();
    @Override
    ...
    public void notifyAudioFileSaveSuccess(AudioModel audio) {
        for (AudioWatcher watcher : list) {
            watcher.audioFileSaveSuccess(audio);
        }
    }
